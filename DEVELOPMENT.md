...
to Knative `jobsource`. Also take a look at:
...
`src/github.com/spencer-p/jobsource` directory in your
...
git clone git@github.com:${YOUR_GITHUB_USERNAME}/jobsource.git
cd jobsource
git remote add upstream https://github.com/spencer-p/jobsource.git
