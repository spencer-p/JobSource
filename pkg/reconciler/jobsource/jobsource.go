...
import (
	...
	"github.com/spencer-p/jobsource/pkg/apis/jobsource/v1alpha1"
	clientset "github.com/spencer-p/jobsource/pkg/client/clientset/versioned"
	listers "github.com/spencer-p/jobsource/pkg/client/listers/jobsource/v1alpha1"
	"go.uber.org/zap"
...
func (r *Reconciler) reconcile(ctx context.Context, jsvc *v1alpha1.JobSource) error {
	if jsvc.GetDeletionTimestamp() != nil {
		// Check for a DeletionTimestamp.  If present, elide the normal reconcile logic.
		// When a controller needs finalizer handling, it would go here.
		return nil
	}
	jsvc.Status.InitializeConditions()

	// TODO What actually needs to happen here?

	jsvc.Status.ObservedGeneration = jsvc.Generation
	return nil
}
...
func (r *Reconciler) updateStatus(desired *v1alpha1.JobSource) (*v1alpha1.JobSource, error) {
	...
	return r.Client.JobsourceV1alpha1().JobSources(desired.Namespace).UpdateStatus(existing)
}
