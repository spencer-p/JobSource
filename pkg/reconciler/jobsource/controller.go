...
import (
	...
	asclient "github.com/spencer-p/jobsource/pkg/client/injection/client"
	asinformer "github.com/spencer-p/jobsource/pkg/client/injection/informers/jobsource/v1alpha1/jobsource"
...
func NewController(
	...
	svcInformer.Informer().AddEventHandler(controller.HandleAll(
		...
		controller.EnsureTypeMeta(
			c.Tracker.OnChanged,
			corev1.SchemeGroupVersion.WithKind("Service"), // TODO Delete this?
		),
	))
	return impl
}
