...
type FakeJobSources struct {
	Fake *FakeJobsourceV1alpha1
	ns   string
}

var jobsourcesResource = schema.GroupVersionResource{Group: "jobsource.spencer-p.github.com", Version: "v1alpha1", Resource: "jobsources"}

var jobsourcesKind = schema.GroupVersionKind{Group: "jobsource.spencer-p.github.com", Version: "v1alpha1", Kind: "JobSource"}
